...
const flavors = [
	{
		...
		description:
			"A zesty explosion of natural lemon and lime that wakes you up instantly.",
	...
	},
	{
		...
		description:
			"Island vibes with every sip. Transport yourself to paradise.",
...
export function FlavorCarousel() {
	...
	const paginate = (newDirection: number) => {
		const newIndex =
			(currentIndex + newDirection + flavors.length) % flavors.length
							...
							>
								<motion.div
									className={`bg-white rounded-3xl p-6 md:p-8 border-2 border-[#121212]/10 shadow-xl ${
										currentFlavor.mystery ? "relative overflow-hidden" : ""
									}`}
									...
									<div className="grid md:grid-cols-2 gap-6 items-center">
										...
										>
											...
											{currentFlavor.mystery && (
												...
												>
													<span className="text-7xl font-black text-[#121212]/20">
														?
													</span>
												</motion.div>
											)}
										...
										<div className="space-y-4">
											...
											{!currentFlavor.mystery && (
												...
												>
													{["Zero Sugar", "Metabolism Boost", "Natural Flavours", "Vitamin Rich"].map(
														(badge) => (
															<span
																key={badge}
